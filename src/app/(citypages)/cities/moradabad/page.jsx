  ...
  return (
    <div className="p-8">
      ...
      <p className="text-gray-700 mb-6">
        ...
        business in Moradabad.
      </p>

      <h2 className="text-2xl font-semibold mb-3">Services in Moradabad</h2>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        {services.map((service) => (
          <Link
            key={service.slug}
            href={`/cities/moradabad/${service.slug}`}
      ...
      <h2 className="text-2xl font-semibold mb-3">Why Choose Us in Moradabad?</h2>
      <ul className="list-disc ml-6 text-gray-700 space-y-2 mb-6">
        ...
        <li>Trusted by multiple Moradabad clients.</li>
        <li>Fast project delivery and real results.</li>
      </ul>

      <p className="text-gray-700">
        Need services in Moradabad?{" "}
