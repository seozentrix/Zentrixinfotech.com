...
export const metadata = {
  title: "Digital Marketing & IT Services in Delhi | Zentrix Infotech",
  description:
    "Zentrix Infotech provides affordable digital marketing, web development, software development, mobile app development, UI/UX design, and cloud services in Delhi. Choose the best IT company for your business growth.",
  keywords: [
    ...
    "affordable digital services Delhi"
  ],
  alternates: {
  ...
  return (
    <div className="p-8">
      <h1 className="text-3xl font-bold mb-3 mt-30">
        Digital Marketing & IT Services in Delhi
      </h1>

      <p className="text-gray-700 mb-6">
        Zentrix Infotech offers affordable and result-driven digital and IT
        solutions in Delhi. We help businesses grow with digital marketing,
      ...
      <h2 className="text-2xl font-semibold mb-3">Services in Delhi</h2>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        {services.map((service) => (
          <Link
            key={service.slug}
            href={`/cities/Delhi/${service.slug}`}
      ...
      <h2 className="text-2xl font-semibold mb-3">Why Choose Us in Delhi?</h2>
      <ul className="list-disc ml-6 text-gray-700 space-y-2 mb-6">
        ...
        <li>Trusted by multiple Delhi clients.</li>
        <li>Fast project delivery and real results.</li>
      </ul>

      <p className="text-gray-700">
        Need services in Delhi?{" "}
