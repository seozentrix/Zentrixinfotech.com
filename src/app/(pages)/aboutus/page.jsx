        ...
        <div>
            <section className="relative px-4 py-16 sm:px-6 lg:px-8 bg-linear-to-br from-slate-50 via-gray-50 to-white overflow-hidden">
                ...
                <div
                    ...
                    style={{
                        background: 'linear-linear(90deg, transparent, rgba(34, 197, 94, 0.1), transparent)',
                ...
                <div className="max-w-7xl lg:pt-32 py-14 mx-auto relative z-10">
                    ...
                    <div className="text-center mb-20">
                        ...
                        <h2 className="text-5xl md:text-6xl lg:text-7xl font-medium font-serif mb-8 leading-tight">
                            <span className="text-slate-900 block">Crafting the future of</span>
                        ...
                        <div className="relative">
                            ...
                            <div className="mt-10 p-6 bg-linear-to-r from-emerald-500/10 to-blue-500/10 rounded-2xl border border-emerald-500/20 backdrop-blur-sm">
                                <div className="flex items-center mb-4">
                                    ...
                                    <h4 className="text-xl font-medium font-serif text-slate-900">Our Mission</h4>
                                </div>
                            ...
                            <div className="bg-linear-to-br from-white/90 to-slate-50/90 rounded-3xl border border-slate-200/50 backdrop-blur-xl p-8 relative overflow-hidden hover:border-emerald-500/50 transition-all duration-500 shadow-xl">
                                ...
                                <div className="relative z-10">
                                    <div className="flex items-center mb-8">
                                        ...
                                        <h4 className="text-2xl font-medium font-serif text-slate-900">Our Values</h4>
                                    </div>
                                    ...
                                    <div className="mb-8 p-6 bg-slate-50/80 rounded-2xl border border-slate-200/50 min-h-[200px] relative overflow-hidden">
                                        <div className="flex items-center mb-4">
                                            ...
                                            <h5 className="text-xl font-bold text-slate-900">{companyValues[activeValue].title}</h5>
                                        </div>
                                        <p className="text-slate-700 leading-relaxed">
                                    ...
                                    <div className="flex justify-center space-x-3">
                                        {companyValues.map((_, index) => (
                                            <button
                                                ...
                                                className={`w-3 h-3 rounded-full transition-all duration-300 ${activeValue === index
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {teamHighlights.map((highlight, index) => (
                            ...
                            >
                                <div className={`w-16 h-16 rounded-2xl bg-linear-to-r ${highlight.linear} mb-6 flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform duration-300 relative overflow-hidden`}>
