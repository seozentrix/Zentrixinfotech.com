                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center w-full">
                        ...
                        <div className="space-y-8">
                            <div className="inline-block">
                                <span className="px-4 py-2 rounded-full text-sm font-semibold text-white" style={{ backgroundColor: '#1AA687' }}>
                                    World's Leading CMS
                                </span>
                            </div>
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium font-serif leading-tight uppercase" style={{ color: '#002D40' }}>
                                Build Powerful<br />
                                <span style={{ color: '#FF414D' }}>AI-Enhanced</span><br />
                                WordPress Sites!
                            </h1>

                            <p className="text-lg leading-relaxed max-w-lg" style={{ color: '#002D40', opacity: 0.8 }}>
                                Create stunning websites with WordPress, the world's most popular CMS platform.
                                Leverage AI-powered design assistance, extensive plugin ecosystem, advanced security protocols, and seamless integrations
                                to build scalable websites that power 43% of the entire web.
                            </p>
                        </div>
                        ...
                        <div className="flex justify-center lg:justify-end">
                            <div className="grid grid-cols-3 gap-4 max-w-md">
                                ...
                                <div className="rounded-xl p-6 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 min-h-[100px]" style={{ backgroundColor: 'rgba(0, 45, 64, 0.05)', borderColor: '#002D40', border: '1px solid' }}>
                                    <span className="font-bold text-lg" style={{ color: '#002D40' }}>The New York Times</span>
                                </div>
                                ...
                                <div className="rounded-xl p-6 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 min-h-[100px]" style={{ backgroundColor: 'rgba(26, 166, 135, 0.05)', borderColor: '#1AA687', border: '1px solid' }}>
                                    <span className="font-bold text-lg" style={{ color: '#1AA687' }}>Sony Music</span>
                                </div>
                                ...
                                <div className="rounded-xl p-6 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 min-h-[100px]" style={{ backgroundColor: 'rgba(255, 106, 121, 0.05)', borderColor: '#FF6A79', border: '1px solid' }}>
                                    <span className="font-bold text-lg" style={{ color: '#FF6A79' }}>Bloomberg</span>
                                </div>
                                ...
                                <div className="rounded-xl p-6 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 min-h-[100px]" style={{ backgroundColor: 'rgba(217, 248, 255, 0.3)', borderColor: '#D9FCF2', border: '1px solid' }}>
                                    <span className="font-bold text-lg" style={{ color: '#1AA687' }}>Disney</span>
                                </div>

                                <div className="rounded-xl p-6 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 min-h-[100px]" style={{ backgroundColor: 'rgba(0, 45, 64, 0.05)', borderColor: '#002D40', border: '1px solid' }}>
                                    <span className="font-bold text-lg" style={{ color: '#002D40' }}>TechCrunch</span>
                                </div>

                                <div className="rounded-xl p-6 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 min-h-[100px]" style={{ backgroundColor: 'rgba(255, 65, 77, 0.05)', borderColor: '#FF414D', border: '1px solid' }}>
                                    <span className="font-bold text-lg" style={{ color: '#FF414D' }}>CNN</span>
                                </div>

                                <div className="rounded-xl p-6 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 min-h-[100px]" style={{ backgroundColor: 'rgba(26, 166, 135, 0.05)', borderColor: '#1AA687', border: '1px solid' }}>
                                    <span className="font-bold text-lg" style={{ color: '#1AA687' }}>BBC America</span>
                                </div>

                                <div className="rounded-xl p-6 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 min-h-[100px]" style={{ backgroundColor: 'rgba(255, 106, 121, 0.05)', borderColor: '#FF6A79', border: '1px solid' }}>
                                    <span className="font-bold text-lg" style={{ color: '#FF6A79' }}>Time Magazine</span>
                                </div>
    ...
    const services = [
        {
            ...
            description: "Create, edit, and publish content effortlessly with WordPress's intuitive editor featuring blocks, media management, and revision control."
        },
        {
            id: 1,
            icon: <Settings className="w-8 h-8" />,
            title: "AI-Powered Design",
            description: "Leverage TypeScript for stronger typing, better IDE support, and fewer runtime errors, ensuring cleaner, more maintainable code Material.",
            isActive: true
        },
        {
            id: 2,
            ...
            description: "Control access with sophisticated user roles and permissions system supporting multiple contributors, editors, and administrators."
        },
        {
            id: 3,
            icon: <Search className="w-8 h-8" />,
            title: "SEO Optimization",
            description: "Built-in SEO features with AI-assisted keyword optimization, meta tag management, and search engine visibility enhancements."
        }
    ];
                    ...
                    <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
                        ...
                        <div className="space-y-6 md:space-y-8 order-2 lg:order-1">
                            <div className="space-y-4 md:space-y-6">
                                ...
                                <h2 className="text-4xl md:text-5xl font-semibold leading-tight uppercase" style={{ color: '#002D40' }}>
                                    WordPress<br />
                                ...
                                <p className="text-base md:text-lg leading-relaxed max-w-md" style={{ color: '#002D40', opacity: 0.8 }}>
                                    Build exceptional websites with WordPress, powering 43% of all websites globally.
                                    Create engaging digital experiences with the world's most flexible and feature-rich CMS platform.
                                </p>
                            </div>
...
const WordPressServicesGrid = () => {
    const services = [
        {
            image: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
            icon: Globe,
            title: "WordPress Website Development",
            description: "Build custom WordPress websites with responsive design, optimized performance, and tailored functionality"
        },
        {
            image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
            icon: FileText,
            title: "WordPress CMS Solutions",
            description: "Implement comprehensive content management systems with advanced publishing workflows and user management"
        },
        {
            image: "https://images.unsplash.com/photo-1581291518633-83b4ebd1d83e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
            icon: Palette,
            title: "Custom Theme Development",
            description: "Create unique WordPress themes with AI-powered design assistance and modern responsive frameworks"
        },
        {
            image: "https://images.unsplash.com/photo-1627398242454-45a1465c2479?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
            icon: Code,
            title: "WordPress Plugin Development",
            description: "Develop custom plugins with advanced functionality, API integrations, and seamless WordPress compatibility"
        },
        {
            image: "https://images.unsplash.com/photo-1544197150-b99a580bb7a8?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
            icon: Database,
            title: "WordPress Migration Services",
            description: "Migrate websites to WordPress from any platform while preserving SEO, data integrity, and functionality"
        },
        {
            image: "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
            icon: Search,
            title: "WordPress SEO Optimization",
            description: "Implement comprehensive SEO strategies with AI-assisted optimization and search engine visibility enhancement"
        },
        {
            image: "https://images.unsplash.com/photo-1563013544-824ae1b704d3?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
            icon: Users,
            title: "WordPress Multisite Networks",
            description: "Build and manage WordPress multisite installations for enterprise-level content management needs"
        },
        {
            image: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
            icon: Headphones,
            title: "WordPress Support & Maintenance",
            description: "Ongoing WordPress maintenance including security updates, performance optimization, and technical support"
        }
    ];
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-16">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium font-serif mb-4 uppercase" style={{ color: '#002D40' }}>
                        WordPress <span className='text-[#FF414D]'>Development</span> Services
                    </h1>
...
const HiringModel = () => {
    ...
    const hiringModels = [
        ...
        },
        {
            ...
            buttonText: "HIRE WORDPRESS TEAM",
            ...
            <div className="container mx-auto max-w-6xl px-5">
                <div className="text-center mb-16">
                    <h2 className="text-4xl md:text-5xl font-bold mb-8" style={{ color: colors.tealGreen }}>
                        Select from Zentrix's WordPress Hiring Models
                    </h2>
                    <p
                        className="text-lg leading-relaxed mx-auto max-w-4xl px-8"
                        style={{ color: colors.darkNavy }}
                    >
                        Scale your WordPress development with our flexible engagement models designed for modern web experiences and content management excellence.
                    </p>
                </div>
